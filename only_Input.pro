-injars target/JOpenCTM-1.0-SNAPSHOT.jar
-outjars target/JOpenCTM-1.0-Input.jar
...
-keep public class darwin.jopenctm.io.CtmFileReader, darwin.jopenctm.compression.MG2Decoder {
